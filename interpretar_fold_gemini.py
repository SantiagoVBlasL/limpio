...
try:
    ...
    log.warning("Librería 'captum' no encontrada. El método 'integrated_gradients' no estará disponible. Instala con: pip install captum")
...
def cmd_saliency(args: argparse.Namespace) -> None:
    ...
    saliency_fn_map = {
        ...
        'smoothgrad': lambda v, w, x, d: generate_saliency_smoothgrad(v, w, x, d, n_samples=args.sg_n_samples, noise_std_perc=args.sg_noise_std),
        'integrated_gradients': lambda v, w, x, d: generate_saliency_integrated_gradients(v, w, x, d, n_steps=args.ig_n_steps)
    }
